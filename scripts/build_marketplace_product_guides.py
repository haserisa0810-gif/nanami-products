...
for name, size, leading, colour, extra in [
    ...
    ("Subtitle", 10, 15, MUTED, {"spaceAfter": 5 * mm}),
    ("H2", 13, 17, ACCENT_DARK, {"spaceBefore": 2 * mm, "spaceAfter": 2 * mm}),
    ("BodyJP", 9.2, 14.5, INK, {"spaceAfter": 2 * mm}),
    ("BodyEN", 8.8, 13.5, INK, {"spaceAfter": 2 * mm}),
    ("Small", 7.6, 11, MUTED, {}),
    ("URL", 8.2, 11, ACCENT_DARK, {"wordWrap": "CJK"}),
