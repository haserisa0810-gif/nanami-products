...
STR = {
    "en": {
        ...
        "scope_full": "All {count} month dashboards, calendars, dated daily pages, monthly reflections, and notes pages are included. Daily pages link to the previous and next day and back to the month calendar.",
        ...
        "scope_personal": "Calculated for the profile on the Personal pages: twelve months from {start}, all dated daily pages, monthly reflections, your personal transit seasons, and monthly focus dates.",
        ...
        "aspects_eyebrow": "SKY OVERVIEW  /  EXACT {tz} MOMENTS",
        ...
        "retro_eyebrow": "STATIONS AND OBSERVATION WINDOWS  /  {tz}",
        "retro_intro": "Periods below are bounded by exact station events in the calculated data. 'Before {start}' indicates a cycle already in progress as the period opens.",
        ...
        "phases_eyebrow": "LUNAR CYCLE  /  EXACT {tz} MOMENTS",
        ...
        "month_questions": ["What changed in observable reality?", "What repeated?", "What did the forecast not explain?"],
        ...
        "linked_daily": "Linked daily page included",
        ...
        "moon_head": "MOON", "phase_suffix": "{phase} phase",
        "major_aspects": "MAJOR ASPECTS",
        "no_major_aspect": "No major aspect inside the display orb",
        "orb_deg": "orb {orb} deg",
        "long_term": "LONG-TERM TRANSITS",
        "your_transits": "YOUR ACTIVE TRANSITS",
        "no_long_term": "No outer-planet major aspect inside the display orb",
        "no_personal_active": "No personal long-term transit active today",
        "peak": "peak {date}",
        ...
        "reflection_eyebrow": "REVIEW THE RECORD  /  KEEP WHAT THE EVIDENCE SUPPORTS",
        "reflection_prompts": [
        ...
        "seasons_intro": "Each bar is a period when a slow-moving body forms an exact aspect to your natal chart. Diamond marks the peak. Darker bars are higher priority.",
        ...
        "no_personal_month": "No selected personal focus in this month.",
        "pm_q1": "WHAT CHANGED AROUND THESE DATES?",
        "pm_q2": "WHERE DID I FEEL MORE CHOICE?",
    ...
    "ja": {
        ...
        "retro_title": "逆行一覧",
        "retro_eyebrow": "留と観察ウィンドウ  /  {tz}",
        "retro_intro": "以下の期間は計算データ内の正確な留イベントで区切られています。「{start}以前」は期間開始時点ですでに逆行中のサイクルを示します。",
        ...
        "body_energy": "体調・エネルギー基準",
        "baseline_items": ["睡眠", "エネルギー", "集中", "緊張"],
        "questions_month": "今月の問い",
        "month_questions": ["観察できる現実で何が変わった？", "何が繰り返された？", "予報が説明しなかったことは？"],
        ...
        "orb_deg": "オーブ {orb} 度",
        "long_term": "長期トランジット",
        "your_transits": "あなたの進行中トランジット",
        "no_long_term": "表示オーブ内の外惑星アスペクトなし",
        "no_personal_active": "本日進行中のパーソナル長期トランジットなし",
        "peak": "ピーク {date}",
        ...
        "reflection_eyebrow": "記録を見直す  /  証拠が支持するものだけ残す",
        "reflection_prompts": [
            "繰り返された出来事や感情は？",
            "関連がありそうだったトランジットの説明は？",
            "実体験と合わなかった説明は？",
            "占星術以外で最も影響した要因は？",
            "来月観察したいことは？",
        ],
        ...
        "layer_common_body": "月相・イングレス・留・集合的アスペクト、そして同じ振り返りジャーナルの構造。",
        ...
        "seasons_importance_high": "重要", "seasons_importance_medium": "中",
        ...
        "no_personal_month": "今月は選定されたパーソナル・フォーカスはありません。",
        "pm_q1": "この日付の前後で何が変わった？",
        "pm_q2": "より選択の自由を感じたのはどこ？",
        "pm_q3": "他に影響した状況は？",
