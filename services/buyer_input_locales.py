...
ERROR_MESSAGES = {
    "ja": {
        ...
        "prefecture_invalid": "出生都道府県の選択が正しくありません。選び直してください。",
        ...
        "exact_time_invalid": "出生時刻は0:00〜23:59の範囲で入力してください。",
    ...
    "en": {
        ...
        "prefecture_invalid": "The selected birth prefecture is invalid. Select it again.",
        ...
        "exact_time_invalid": "Enter the birth time between 0:00 and 23:59.",
    ...
    "es": {
        ...
        "prefecture_required": "Selecciona la prefectura de nacimiento.", "prefecture_invalid": "La prefectura seleccionada no es válida. Vuelve a seleccionarla.", "domestic_overseas_fields": "Para un nacimiento en Japón, deja vacíos el lugar internacional y la zona horaria.",
        "coordinate_pair": "Introduce tanto la latitud como la longitud.", "latitude": "latitud", "longitude": "longitud",
        "exact_time_required": "Introduce la hora de nacimiento al seleccionar Hora exacta.", "exact_time_invalid": "Introduce una hora de nacimiento entre las 0:00 y las 23:59.", "time_choice_invalid": "La precisión de la hora seleccionada no es válida.",
    ...
    "de": {
        ...
        "prefecture_required": "Wähle die Geburtspräfektur.", "prefecture_invalid": "Die ausgewählte Geburtspräfektur ist ungültig. Wähle sie erneut aus.", "domestic_overseas_fields": "Lass bei einer Geburt in Japan den internationalen Ort und die Zeitzone leer.",
        "coordinate_pair": "Gib sowohl Breiten- als auch Längengrad ein.", "latitude": "Breitengrad", "longitude": "Längengrad",
        "exact_time_required": "Gib die Geburtszeit ein, wenn Genaue Uhrzeit ausgewählt ist.", "exact_time_invalid": "Gib eine Geburtszeit zwischen 0:00 und 23:59 ein.", "time_choice_invalid": "Die gewählte Genauigkeit der Geburtszeit ist ungültig.",
