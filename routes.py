...
I18N = {
    "ja": {
        ...
        "copy_yaml_only": "選択中のYAMLだけコピー",
        "copy_yaml_only_hint": "占いプロンプトを含まないYAMLデータのみをコピーできます。保存用や他のAIサービスでの活用に使えます。",
    ...
    "en": {
        ...
        "copy_yaml_only": "Copy selected YAML only",
        "copy_yaml_only_hint": "Copy only the YAML data without the astrology reading prompt. Use it for storage or with other AI services.",
