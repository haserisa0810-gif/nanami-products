...
I18N = {
    "ja": {
        ...
        "copy_yaml_only": "YAMLだけコピー",
        "copy_yaml_only_hint": "AI活用や保存用に、占いプロンプトを含まないYAMLデータのみをコピーできます。",
    ...
    "en": {
        ...
        "copy_yaml_only": "Copy YAML only",
        "copy_yaml_only_hint": "Copy only the YAML data, without the astrology reading prompt, for AI use or storage.",
